...
export const quickLinks = [
  {
    title: 'What is Nevellus',
    href: '#',
    icon: InformationCircleIcon,
    to: './docs/intro',
    text: `Here you will learn the concepts of the platform. Swaps, Pools, Goals and more.`,
  },
  {
    ...
    text: `Technical information of the Nevellus smart contracts.`,
  },
  {
    title: 'Tutorials',
    href: '#',
    ...
    text: `Step by step guide of how to use the Nevellus platform services.`,
  },
];
...
export const Guides = [
  {
    title: 'Quick Start',
    text: 'Learn how to interact with the Nevellus AMM',
    to: './docs/Tutorials/How%20to%20Get%20Started%20on%20Nevellus/How%20to%20Swap',
  },
  {
    title: 'Providing Liquidity',
    text: 'Provide liquidity from a smart contract ',
    to: './docs/Tutorials/How%20to%20Get%20Started%20on%20Nevellus/How%20to%20Add%20&%20Remove%20Liquidity',
  },
  {
    title: 'Subgraph Quick Start',
    text: 'Learn how to interact with the Nevellus suite of subgraphs',
    ...
    >
      <Container>
        <DocsHeader>
          ...
          >
            <h1 style={{ fontWeight: '700' }}> Nevellus Docs</h1>
          </div>
          <StyledTitleImage
            alt=""
            sources={{
              light: useBaseUrl('/img/nevellusbg.jpg'),
              dark: useBaseUrl('/img/nevellusbg.jpg'),
            }}
          />
          <Row>
            {quickLinks.map((link) => (
        ...
        >
          <div>
            ...
            <p>
              Explore these docs to get started integrating the Nevellus in your dApp,
          ...
          <div>
            ...
            <p>The Nevellus codebase is comprised of an ecosystem of open source components.</p>
            {github.map((action) => (
